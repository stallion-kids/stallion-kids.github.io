class MachineLearningText { 
    ...
    getInfo() {
        ...
        return {
            ...
            id: 'mlforkidstext95c1cc605d0f11eaa486a15a771c11c5',
            ...
            blocks: [
                ...
                {
                    opcode: 'return_label_0',
                    blockType: Scratch.BlockType.REPORTER,
                    text: ' hi'
                },
                {
                    opcode: 'return_label_1',
                    blockType: Scratch.BlockType.REPORTER,
                    text: ' bye'
                },
...
predict(args) {
    ...
    addTraining({ TEXT, LABEL }) {
        ...
        var url = new URL('https://machinelearningforkids.co.uk/api/scratch/bdeba0d0-5d0f-11ea-8d15-5d8b417d938ec95e4c4d-0062-4a6a-af17-05dec5652c7c/train');
...
function classifyText(text, cacheKey, lastmodified, callback) {
    var url = new URL('https://machinelearningforkids.co.uk/api/scratch/bdeba0d0-5d0f-11ea-8d15-5d8b417d938ec95e4c4d-0062-4a6a-af17-05dec5652c7c/classify');
...
function trainNewClassifier() {
    ...
    var url = new URL('https://machinelearningforkids.co.uk/api/scratch/bdeba0d0-5d0f-11ea-8d15-5d8b417d938ec95e4c4d-0062-4a6a-af17-05dec5652c7c/models');
    var options = {
        headers : {
            'Accept': 'application/json',
            'Content-Type': 'application/json',
...
function fetchStatus() {
    ...
    var url = new URL('https://machinelearningforkids.co.uk/api/scratch/bdeba0d0-5d0f-11ea-8d15-5d8b417d938ec95e4c4d-0062-4a6a-af17-05dec5652c7c/status');
    var options = {
        headers : {
            'Accept': 'application/json',
            'Content-Type': 'application/json',
